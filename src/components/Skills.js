...
const styles = {
  ...
  <motion.section ref={ref} className='section font-primary'
    ...
    <div className="container mx-auto">
      <div className='flex flex-col xl:flex-row xl:gap-x-12 justify-between items-center gap-y-12'>
      {/* circular item */}
        <div className='w-[150px] lg:w-[275px] flex 
        flex-col items-center gap-y-6'>
          <CircularProgressbar
          strokeWidth={1}
          value={fullBody}
          styles={styles}
