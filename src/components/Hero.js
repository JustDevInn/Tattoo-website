...
const Hero = () => {
  ...
  return (
    // lg:h-[948px] has been adjusted to 648 to fit the screen
  <section className='bg-hero bg-cover bg-center min-h-[40vh
   lg:h-[648px] bg-no-repeat relative mt-[120px]
   lg:mt-[150px]'>
  <motion.div
  variants={container}
  initial='hidden'
  whileInView={'show'}
  className="container mx-auto min-h-[40vh] lg:h-full
   flex items-center justify-center xl:justify-end">
    {/* text & btn*/}
    <div className='text-white text-center lf:text-left lg:max-w-[640px] '>
    {/* text */}
      <motion.h1
